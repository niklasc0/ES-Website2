...
**Stand:** 31.08.2026 · Plugin **1.6.32** · Theme **2.6.32**
**Basis:** Live-Export von test2 vom 31.08., 15:00 Uhr. Elkes Änderungen seit dem letzten Stand (neue Texte für Investition und Transformation sowie Transaktion und Kooperation, aktualisierte Kurzvita Elke Beermann, Textkorrekturen im Home-Hero) sind in die Import-Daten eingearbeitet; „Import erzwingen" überschreibt davon nichts mehr.

## Vorbereitung auf test2

1. Theme-ZIP 2.6.32 und das **volle** Plugin-ZIP 1.6.32 einspielen (nicht das slim-ZIP, der Import braucht die mitgelieferten Daten).
...
4. Schnellcheck: Unter Plugins muss 1.6.32 stehen, unter Design das Theme 2.6.32.
...
| B13 | ESG eigene Rubrik | /leistung/umweltrecht/ | Sechs Aufklapp-Rubriken, „Compliance und ESG" als eigener Punkt (Voraussetzung wie B10: Plugin 1.6.32 aktiv) |
...
| Prüfen | Wo | Erwartet |
|---|---|---|
| Publikationen-Schalter | Design → Layout | Drei Checkboxen „Publikationen auf Beratungsfeld-Seiten"; Haken entfernen blendet den Bereich auf der jeweiligen Seite (DE und EN) komplett aus |
