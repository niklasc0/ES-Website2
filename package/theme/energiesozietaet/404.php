...
<section class="es-stage es-stage--dark es-stage-sec es-round-bottom" style="min-height:46vh;display:flex;align-items:center;">
	<div class="es-wrap" style="padding:120px 24px;">
