			...
			<div class="es-leistung__grid">
				...
				<aside class="es-leistung__aside">
					<div class="es-leistung__card">
						...
						<p class="es-leistung__card-text">Sie haben ein konkretes Vorhaben rund um <?php echo esc_html( get_the_title() ); ?>? Wir ordnen es fachübergreifend ein — auf den Punkt.</p>
